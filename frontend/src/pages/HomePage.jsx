    ...
    <div>
      ...
      <section className="homeblog-section">
        <div className="blog-content">
          ...
          <div className="blog-image">
            <img src="/src/assets/images/IJC_Blog_MAY22-removebg-preview.png" alt="Explore Our Blog" />
          </div>
        </div>
      </section>
      <section className="homeshop-section">
        <div className="section-content">
          <div className="section-image">
            <img src="src/assets/images/ecommerce-sales-featured-image-removebg-preview.png" alt="Shop the Latest Trends" />
          </div>
          <div className="section-text">
            ...
            <Link className="nav-link" to="/ecommercepage">Start Shopping</Link>
          </div>
        </div>
      </section>
      <section className="contact-section">
        <div className="section-content">
          ...
          <div className="section-image">
            <img src="/src/assets/images/vecteezy_concept-illustration-of-man-and-woman-friends-having-online_8296859-removebg-preview.png" alt="Get in Touch" />
          </div>
        </div>
      </section>
      <Testimonials />
